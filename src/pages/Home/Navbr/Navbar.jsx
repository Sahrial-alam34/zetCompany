        ...
        <div className='px-4 py-5 mx-auto  sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 text-white'>
            <div className='relative flex items-center justify-between'>
                ...
                <div className='items-center hidden space-x-8 lg:flex'>
                    ...
                    <button className="btn btn-active btn-primary text-[20px]">Download ZET</button>
                            ...
                            <div className='p-5 bg-white border rounded shadow-sm'>
                                ...
                                <nav className='flex flex-col'>
                                    <div className='items-center space-x-8 lg:flex'>
                                        ...
                                        <button className="btn btn-active btn-primary  ">Download ZET</button>
